...
\textbf{Change Writing Tools} \\ Inserting, removing, and replacing writing implements must be convenient and fast.} \\
...
\item A \added[remark={New requirements to replace Change Writing Tools requirement}]{writing implement must be able to be removed from a single robot by a user in under 1 minute. Writing tools will need to be removed when the existing implement becomes unusable.}
\end{functional_requirement}
