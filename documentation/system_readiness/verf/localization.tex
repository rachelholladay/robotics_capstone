...
\textbf{Operational Procedure:} With a single robot within the working bounds, the localization system attempts to determine the robot's location. \added[remark={NJ,V2}]{Robot operation out of bounds is also considered out of scope, and is undefined behavior.}\\
