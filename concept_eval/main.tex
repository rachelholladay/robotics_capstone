...
\rhnote{Need to fix references in system description and concept operation. Need to explain deployment in installation. Need to full in subsystem listing. Need fix each subsystem description. Need to add requirements fulfilled. Need to add artistic sketch + trade study. Need to add research for planning.}
