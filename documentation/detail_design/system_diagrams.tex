...
The electronics system on each robot is detailed in the full electronics diagram \figref{fig:electronics-diagram}.
...
Two motor HATs will be stacked onto the Raspberry Pi for each robot, as illustratred in \figref{fig:HATs}.
...
\added[remark={NJ, V2}]{For a port-to-port connection table for the electronics in the system, refer to} \figref{fig:electronics-table}.
