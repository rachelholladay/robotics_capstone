...
\begin{titlepage}
	...
	\vspace{1.5cm}
	{\huge\bfseries Detailed Design\par}
	\vspace{2cm}
...
\input{system_diagrams.tex}
\input{operational_modes.tex}
\input{hardware_fab.tex}
\input{parts.tex}
\input{software_implementation.tex}
\input{failure_states.tex}
\input{install_plan.tex}
