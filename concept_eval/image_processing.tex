...
\added[remark={NJ,V2}]{This software system was designed based around taking user input in the form of an image, and processing into a format best suited for use in the work scheduling system (\sref{sec:planner}).} \\
