...
\deleted[remark={NJ, V2}]{\textbf{Test Question:} Is a human user able to reload the writing tool?}
\deleted[remark={NJ, V2}]{\textbf{Operational Procedure:} A human test subject attempts to reload the writing tool already installed in the robot.}
\deleted[remark={NJ, V2}]{\textbf{Metric:} Whether or not the human succeeds in the task before giving up.}
\deleted[remark={NJ, V2}]{\textbf{Acceptance Criteria:} The human must successfully reload the writing tool without giving up.}
\deleted[remark={NJ, V2}]{\textbf{Requirement(s) Verified:} \frref{fr:insert_tool} \frref{fr:remove_tool}}
