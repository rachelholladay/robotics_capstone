...
\begin{figure}
 \centering
 \caption{Model for reloading the writing implement}
  \includegraphics{figs/airport_layout.jpg}
 \label{fig:Model: Reload Writing Implement}
\end{figure}
...
\begin{figure}
 \centering
 \caption{Model for processing the input image}
  \includegraphics{figs/use_case-process_input_image.jpg}
 \label{fig:Model: Reload Writing Implement}
\end{figure}
...
\begin{figure}
 ...
 \caption{Model for localization}
  \includegraphics{figs/use_case-localization.jpg}
 \label{fig:Model: Localization}
\end{figure}
...
\begin{figure}
 \centering
 \caption{Model for scheduling and robot planning/coordination}
  \includegraphics{figs/use_case-planning_coordination.jpg}
 \label{fig:Model: Scheduling and Robot Planning/Coordination}
\end{figure}
...
\begin{figure}
 \centering
 \caption{Model for moving a robot}
  \includegraphics{figs/use_case-moving.jpg}
 \label{fig:Model: Moving the Robot}
\end{figure}
...
\begin{figure}
 ...
 \caption{Model for using the writing implement}
  \includegraphics{figs/use_case-use_writing_implement.jpg}
 \label{fig:Model: Using Writing Implement}
\end{figure}
