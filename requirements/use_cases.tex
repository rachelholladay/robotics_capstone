...
\rhnote{Need to have one big figure on how use cases relate to each other}
...
\textbf{Model:} \figref{fig:reload_process}.\\
...
\textbf{Model:} \figref{fig:localize}.\\
...
\textbf{Model} \figref{fig:scheduling_moving}.\\
...
\textbf{Model:} \figref{fig:use_tool}.\\
