...
\textbf{Requirement(s) Verified:} \rhnote{emergency stop one and safety} 
...
\textbf{Requirement(s) Verified:} \rhnote{safety and error reporting} 
...
\textbf{Requirement(s) Verified:} \rhnote{error handling and ease of user use}
...
\textbf{Requirement(s) Verified:} \rhnote{emergency stop one} 
...
\textbf{Requirement(s) Verified:} \rhnote{error handling one} 
