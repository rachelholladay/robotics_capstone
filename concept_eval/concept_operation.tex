...
Above, in \figref{fig:concept_operation} we outline the user experience with the system. This is detailed below and our user interface is fully explained in \sref{sec:subsystem_ui}.
