...
\added[remark={NJ,V2}]{This software system was designed based around taking user input in the form of an image, and processing into a format best suited for use in the work scheduling system (\sref{sec:planning}).} \\
...
\added[remark={RH, V2}]{Our input system, as seen in \figref{fig:image_processing} allows a user to input an image (FR11). Each component is designed with error handling (NFR2) and reliability (NFR8).}
