...
\added[remark={RH, V2}]{Critical components to this system include} the writing implement holder, actuation mechanism, writing material levels sensor and reloading mechanism. \added[remark={RH, V2}]{We discuss these mechanical components in further detail in our trade study.}\\
