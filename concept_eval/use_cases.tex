...
\dznote{It's more specific. That's all we got.}

\added[remark={replaced individual use case diagram with a single diagram}]{New Image}
\begin{figure}
 \centering
...
\textbf{Summary:} The robot moves across the writing surface, using its writing implement when required. By using a holonomic drive mechanism, the robot can make sharp turns and intricate designs. For further details, see the Locomotion subsystem description (\sref{sec:subsystem_locomotion}).\\
