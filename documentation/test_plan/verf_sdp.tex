...
\textbf{Requirement(s) Verified:} \rhnote{in bounds, collisions, safety}
...
\textbf{Requirement(s) Verified:} \rhnote{speedup}
...
\textbf{Requirement(s) Verified:} \rhnote{speed up}
...
\textbf{Requirement(s) Verified:} \rhnote{safety}
...
\textbf{Requirement(s) Verified:} \rhnote{autonomous}
