...
\item .\added[remark={New requirements to replace Change Writing Tools requirement}]{A writing implement must be able to be removed from a single robot by a user under 1 minute. Writing tools will need to be removed when the existing implement becomes unusable.}
\end{functional_requirement}
