...
\result{The emergency stop shuts down the system essentially immediately.}
...
\result{Errors are reported within our time bound.}
...
\result{We did not test with non-developers, however our developers were able to interpret the errors. }
...
\result{The emergency stop shut down the system.}
...
\textbf{Requirement(s) Verified:} NFR1, NFR2, FR14 \\
\result{We reported almost all errors.}
