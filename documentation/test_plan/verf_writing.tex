...
\textbf{Requirement(s) Verified:} \dznote{reload time}

\subsubsection{Performance Test: Writing Quality}
\label{sec:writing_pt_qual}
...
\textbf{Requirement(s) Verified:} \dznote{drawing quality} \\

\subsubsection{Functional Test: Replace Writing Tool}
\label{sec:writing_ft_load}
...
\textbf{Requirement(s) Verified:} \dznote{load writing tool}\\

\subsubsection{Functional Test: Writing Pressure Control}
\label{sec:writing_ft_pressure}
...
\textbf{Requirement(s) Verified:} \dznote{thickness}

\subsubsection{Functional Test: Simutaneous Driving and Writing}
\label{sec:writing_ft_both}
...
\textbf{Requirement(s) Verified:} \dznote{writing}

\subsubsection{Functional Test: Marking}
\label{sec:writing_ft_mark}
\textbf{Test Question:} Does the writing tool make a mark when pushed down? \\
