...
\result{We experienced an unexpected amount of latency in our communication, however we could not trace the issue to anything within our system considering the issue occurred seemingly non-deterministically.}
...
\result{We were able to send and recieve on both ends.}
