...
\begin{center}
 ...
 \hline
 \nfrref{nfr:documentation} & \tref{test:ui_pt_error_understand}, \tref{test:ui_ft_error_reporting}, \tref{test:sys_ft_Documentation} \\
 \hline
 ...
 \hline
 \nfrref{nfr:quality} & \tref{test:writing_pt_qual}, \tref{test:writing_ft_both}, \tref{test:writing_ft_mark}, \tref{test:writing_ft_force}, \tref{test:localization_pt_accuracy}, \tref{test:localization_ft_robopos}, \tref{test:localization_ft_bounds}, \tref{test:image_pt_accuracy}, \tref{test:sys_pt_accuracy} \\
 \hline
 \nfrref{nfr:mobileapp} & \tref{test:ui_pt_error_understand}, \tref{test:ui_ft_error_reporting} \\
 \hline
 \nfrref{nfr:reliability} & \tref{test:comm_pt_reliability}, \tref{test:sys_pt_reliability}\\
 \hline
