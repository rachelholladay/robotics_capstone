...
Drawing infrastructure lanes, such as those for parking lots, highways, streets, and airports, can often be dull and expensive \cite{airportdoc,linesalary}. For example, in \figref{fig:airport}, we can see the massive amount of routing lines that airport runway systems rely on. However, these lines are usually painted via a human operator. Therefore, we have the opportunity to improve this task through our robotic system. 
